...
CREATE TABLE Agendamento (
    ...
    CONSTRAINT fk_cpf_paciente FOREIGN KEY (cpf_paciente) REFERENCES Paciente(cpf_pessoa)
    CONSTRAINT fk_cpf_pessoa FOREIGN KEY (cpf_pessoa) REFERENCES Medico(cpf_pessoa)
)
...
CREATE TABLE Medico_Especialidade (
    ...
    CONSTRAINT fk_cpf_medico FOREIGN KEY (cpf_medico) REFERENCES Medico(cpf_pessoa)
