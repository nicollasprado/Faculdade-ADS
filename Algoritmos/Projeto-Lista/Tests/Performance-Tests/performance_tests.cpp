...
unsigned int choose_input_size(){
    ...
    std::cout << "Digite a quantidade de valores da lista, max: 500000 e min: 1000: " << std::endl;

    while(quantity_test_list < 1000 || quantity_test_list > 500000){
        ...
        }else if(quantity_test_list > 500000){
